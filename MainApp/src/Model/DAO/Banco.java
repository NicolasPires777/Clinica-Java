...
public class Banco {
    ...
    public static void inicia() throws ParseException{
        ...
        Usuario usuario1 = new Usuario(1, "renan", 'M', "18/07/1990", "30212121", "renanmedico@gmail.com", "521454123", "medico", "Urologista");
        ...
        Servico servico1 = new Servico(1, "Dermatologista", 150);
        Servico servico2 = new Servico(2, "Clinico Geral", 120);
        Servico servico3 = new Servico(3, "Urologista", 200);
        Servico servico4 = new Servico(4, "Ginecologista", 250);
        Servico servico5 = new Servico(5, "Ortopedista", 100);
        Servico servico6 = new Servico(6, "Otorrinolaringologista", 150);

        Agendamento agendamento1 = new Agendamento(1, cliente9, servico6, 150, "28/11/2023 14:00", "Retorno");
        Agendamento agendamento2 = new Agendamento(2, cliente3, servico1, 150, "28/11/2023 14:00", "Primeira Consulta");
        Agendamento agendamento3 = new Agendamento(3, cliente5, servico3, 200, "28/11/2023 14:00", "Exames Pendentes");
